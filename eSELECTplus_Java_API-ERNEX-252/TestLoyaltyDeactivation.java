...
/********************** Request Variables ****************************/
        ...
        String cvd_value = args[9];
        
        ErnexLoyaltyDeactivation eld = new ErnexLoyaltyDeactivation (order_id, cust_id, track2, pan, expdate, cvd_value, language_code, info);

        ErnexHttpsPostRequest mpgReq =
            new ErnexHttpsPostRequest(host, store_id, api_token, eld);
...
} // end TestLoyaltyDeactivation Class