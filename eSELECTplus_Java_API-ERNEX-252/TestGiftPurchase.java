...
/********************** Request Variables ****************************/
        ...
        ErnexGiftPurchase egp = new ErnexGiftPurchase (order_id, cust_id, total_amount,
        		track2, pan, expdate, cvd_value, language_code, info);

        ErnexHttpsPostRequest mpgReq =
            new ErnexHttpsPostRequest(host, store_id, api_token, egp);
