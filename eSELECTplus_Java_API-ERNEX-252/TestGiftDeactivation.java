...
/********************** Request Variables ****************************/
        ...
        ErnexGiftDeactivation egd = new ErnexGiftDeactivation (order_id, cust_id, track2, pan, expdate, cvd_value, language_code, info);

        ErnexHttpsPostRequest mpgReq =
            new ErnexHttpsPostRequest(host, store_id, api_token, egd);
