...
/********************** Request Variables ****************************/
        ...
        String order_id = "loytest10";
        String cust_id = "chris"; //optional
        String total_amount = "5.00";
        String track2 = ";0612040000001000383=00000000?";
        String pan = "0612040000001000383";
        String expdate = "0000";
        String cvd_value = "123";
        String info = "1";
        String language_code = "1";
        String reference_number = "37314562";
        String benefit_amount = "1.00";
        
        ErnexLoyaltyIndRefund elir = new ErnexLoyaltyIndRefund (order_id, cust_id, total_amount,
        		track2, pan, expdate, cvd_value, language_code, info, reference_number, benefit_amount);

        ErnexHttpsPostRequest mpgReq =
            new ErnexHttpsPostRequest(host, store_id, api_token, elir);
