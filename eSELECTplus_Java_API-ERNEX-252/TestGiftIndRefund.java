...
/********************** Request Variables ****************************/
        ...
        String info = args[9];
        String language_code = args[10];
        String reference_number = args[11];
        
        ErnexGiftIndRefund egir = new ErnexGiftIndRefund (order_id, cust_id, total_amount,
        		track2, pan, expdate, cvd_value, language_code, info, reference_number);

        ErnexHttpsPostRequest mpgReq =
            new ErnexHttpsPostRequest(host, store_id, api_token, egir);
