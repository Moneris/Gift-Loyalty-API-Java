...
/********************** Request Variables ****************************/
        ...
        String order_id = "loytest7";
        String txn_number = "1695-1265389671926-00035695_7";
        String total_amount = "2.00";
        String benefit_amount = "2.00";
                
        ErnexLoyaltyRefund elr = new ErnexLoyaltyRefund (order_id, txn_number, total_amount, benefit_amount);
