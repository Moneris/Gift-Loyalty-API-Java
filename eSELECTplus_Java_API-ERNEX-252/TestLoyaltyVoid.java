...
/********************** Request Variables ****************************/
        ...
        String order_id = "loytest2";
        String cvd_value = "123";
        String txn_number = "1675-1265387802789-00035695_7";
                
        ErnexLoyaltyVoid elv = new ErnexLoyaltyVoid (order_id, txn_number, cvd_value);

        ErnexHttpsPostRequest mpgReq =
            new ErnexHttpsPostRequest(host, store_id, api_token, elv);
