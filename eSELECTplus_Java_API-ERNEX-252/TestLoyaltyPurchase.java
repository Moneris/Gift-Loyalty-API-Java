...
/********************** Request Variables ****************************/
        ...
        String host = "esweb.corp.moneris.com";
        ...
        String track2 = args[5];
        String pan = args[6];
        String expdate = args[7];
        String cvd_value = args[8];
        String language_code = args[9];
        String info = args[10];
        String benefit_amount = args[11];
        String payment_type = args[12];
                
        ErnexLoyaltyPurchase elp = new ErnexLoyaltyPurchase (order_id, cust_id, total_amount,
        		track2, pan, expdate, cvd_value, language_code, info, benefit_amount, payment_type);

        ErnexHttpsPostRequest mpgReq =
            new ErnexHttpsPostRequest(host, store_id, api_token, elp);
