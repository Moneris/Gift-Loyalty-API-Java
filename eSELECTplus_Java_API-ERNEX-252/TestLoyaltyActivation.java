...
/********************** Request Variables ****************************/
        ...
        String track2 = args[4];
        String initial_amount = args[5];
        String info = args[6];
        String language_code = args[7];
        String cvd_value = args[8];
        String pan = args[9];
        String expdate = args[10];
        
        ErnexLoyaltyActivation ela = new ErnexLoyaltyActivation (order_id, cust_id, initial_amount, track2,
        		pan, expdate, cvd_value, language_code, info);

        ErnexHttpsPostRequest mpgReq =
            new ErnexHttpsPostRequest(host, store_id, api_token, ela);
        ...
        try
        {
            ...
            System.out.println("LifetimeBalance = " + receipt.getLifetimeBalance());
...
} // end TestLoyaltyActivation Class