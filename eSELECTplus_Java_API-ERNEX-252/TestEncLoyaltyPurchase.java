...
/********************** Request Variables ****************************/
        ...
        EncErnexLoyaltyPurchase elp = new EncErnexLoyaltyPurchase (order_id, cust_id, total_amount,
        		enc_track2, cvd_value, language_code, info, benefit_amount, payment_type);
...
} // end TestEncLoyaltyPreauth Class