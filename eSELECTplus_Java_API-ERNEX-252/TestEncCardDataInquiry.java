...
public class TestEncCardDataInquiry
{
...
/********************** Request Variables ****************************/
        ...
        EncErnexCardDataInq ecdi = new EncErnexCardDataInq (enc_track2);

        ErnexHttpsPostRequest mpgReq =
            new ErnexHttpsPostRequest(host, store_id, api_token, ecdi);
