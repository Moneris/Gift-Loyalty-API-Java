...
/********************** Request Variables ****************************/
        ...
        ErnexGiftCardInq egci = new ErnexGiftCardInq (track2, pan, expdate, cvd_value, language_code);

        ErnexHttpsPostRequest mpgReq =
            new ErnexHttpsPostRequest(host, store_id, api_token, egci);
