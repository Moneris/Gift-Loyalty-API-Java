...
/********************** Request Variables ****************************/
        ...
        String info = args[10];
        String benefit = args[11];
                        
        ErnexLoyaltyRedemption elr = new ErnexLoyaltyRedemption (order_id, cust_id, total_amount,
        		track2, pan, expdate, cvd_value, language_code, info, benefit);
...
} // end TestLoyaltyRedemption Class