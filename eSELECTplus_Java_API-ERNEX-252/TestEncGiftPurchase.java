...
/********************** Request Variables ****************************/
        ...
        EncErnexGiftPurchase egp = new EncErnexGiftPurchase (order_id, cust_id, total_amount,
        		enc_track2, cvd_value, language_code, info);

        ErnexHttpsPostRequest mpgReq =
            new ErnexHttpsPostRequest(host, store_id, api_token, egp, status);
