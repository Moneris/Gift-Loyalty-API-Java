...
/********************** Request Variables ****************************/
        ...
        ErnexLoyaltyCompletion elc = new ErnexLoyaltyCompletion (order_id, txn_number, total_amount, benefit_amount);

        ErnexHttpsPostRequest mpgReq =
            new ErnexHttpsPostRequest(host, store_id, api_token, elc);
